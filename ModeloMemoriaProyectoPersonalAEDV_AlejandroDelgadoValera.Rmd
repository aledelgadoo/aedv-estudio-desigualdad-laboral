...
```{verbatim evolucion-horas-españa-data, results=F}
horas.españa <- data %>% 
...
horas.españa
```
```{verbatim evolucion-horas-españa}
horas.españa %>% 
    autoplot() +
...
```{verbatim evolucion-horas-españa-covid-data, results=FALSE}
...
```{verbatim evolucion-horas-españa-canarias}
...
```{verbatim evolucion-horas-españa-europa}
...
```{verbatim evolucion-horas-españa-arima, results = F}
horas.españa.omit.covid.arima <- horas.españa.omit.covid %>% 
    model(ARIMA(values))
```
```{verbatim descomposicion-horas-españa}
...
```{verbatim evolucion-horas-españa-prediccion}
